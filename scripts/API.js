...
function weatherReport(city_name) {
    ...
    var XYLoc = new Array(25); //states of Ukraine
    XYLoc[0] = ["44.952116", "34.102411"]; //Симферополь
    XYLoc[1] = ["49.2327800", "28.4809700"]; //Винницы
    XYLoc[2] = ["50.7593200", "25.3424400"]; //Луцк
    XYLoc[3] = ["48.4500000", "34.9833300"]; //Днепро
    XYLoc[4] = ["48.0230000", "37.8022400"]; //Донецк
    XYLoc[5] = ["50.2648700", "28.6766900"]; //Житомир
    XYLoc[6] = ["48.6166700", "22.3000000"]; //Ужгород
    XYLoc[7] = ["47.8228900", "35.1903100"]; //Запорожье
    XYLoc[8] = ["48.9215000", "24.7097200"]; //Ивано-Франковск
    XYLoc[9] = ["50.4546600", "30.5238000"]; //Киев
    XYLoc[10] = ["48.5132000", "32.2597000"]; //Кропивницкий
    XYLoc[11] = ["48.5670500", "39.3170600"]; //Луганск
    XYLoc[12] = ["49.8382600", "24.0232400"]; //Львов
    XYLoc[13] = ["46.9659100", "31.9974000"]; //Николаев
    XYLoc[14] = ["46.4774700", "30.7326200"]; //Одесса
    XYLoc[15] = ["49.5937300", "34.5407300"]; //Полтава
    XYLoc[16] = ["50.6230800", "26.2274300"]; //Ровно
    XYLoc[17] = ["50.9216000", "34.8002900"]; //Сумы
    XYLoc[18] = ["49.5558900", "25.6055600"]; //Тернополь
    XYLoc[19] = ["49.9808100", "36.2527200"]; //Харьков
    XYLoc[20] = ["46.6558100", "32.6178000"]; //Херсон
    XYLoc[21] = ["49.4216100", "26.9965300"]; //Хмельницкий
    XYLoc[22] = ["49.4285400", "32.0620700"]; //Черкассы
    XYLoc[23] = ["51.5055100", "31.2848700"]; //Чернигов
    XYLoc[24] = ["48.5422500", "28.1147300"]; //Черновцы
